export const baseCommunities = [
    ...
    {id: new Date().toISOString(), title: "Lênin, de três", image: "https://img10.orkut.br.com/community/f0131f9cec84100d3b7e02bd8a9323c2.jpg"},
...
export const orkutDocs = [
    ...
    { name: 'Videos', slug: '2', icon: 'video-camera' },
    { name: 'Fãs', slug: '8', icon: 'star' },
    { name: 'Mensagens', slug: '2', icon: 'email' }
];

export const trustCoolSexyCounter = [
    { name: 'Confiável', slug: '3', icon: 'smile' },
    { name: 'Legal', slug: '2', icon: 'cool' },
    { name: 'Sexy', slug: '1', icon: 'heart' }
]